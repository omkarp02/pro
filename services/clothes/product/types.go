...
type ProductFitlerRes struct {
	Color      string   `bson:"color,omitempty"`
	Sizes      []string `bson:"size,omitempty"`
	TotalStock int      `bson:"totalStock,omitempty"`
}
