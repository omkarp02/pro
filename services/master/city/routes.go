...
type CityService interface {
	...
	Find(ctx context.Context, filterPayload FilterListModel) ([]TCityRes, error)
...
func NewHandler(service CityService, cfg *config.Config, validator *validation.Validator) *Handler {
